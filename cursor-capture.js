...
(function (global) {
  ...
  function ensureCss() {
    ...
    s.textContent = `
      ...
      #cursorDock {
        position: fixed; z-index: 183; left: 50%; bottom: 14px; transform: translateX(-50%);
