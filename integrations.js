...
// (email, iMessage). Lives OUTSIDE the repo in the user data home
// so nothing credential-adjacent is ever committed.
const fs = require('fs');
const path = require('path');
const dataHome = require('./data-home');

const CONFIG_PATH =
  process.env.INTEGRATIONS_PATH || path.join(dataHome.dataDir(), 'integrations.json');
